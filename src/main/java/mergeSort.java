...
public class mergeSort {
    private ArrayList<Events> inputArray;

    /**
     *
     * @return returns the sorted arrayList
     */
    public ArrayList<Events> getSortedArray() {
        return inputArray;
    }
     ...
     */
    public mergeSort(ArrayList<Events> inputArray){
    ...
    public void merger(int startIndex,int midIndex,int endIndex){
        ...
        ArrayList<Events> mergedSortedArray = new ArrayList<>();

        int leftIndex = startIndex;
        int rightIndex = midIndex+1;

        while(leftIndex<=midIndex && rightIndex<=endIndex){
            if(inputArray.get(leftIndex).getDate() <= inputArray.get(rightIndex).getDate()){
